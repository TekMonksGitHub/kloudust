...
function _setupKloudustEnvironment(asyncContextStorage, name, id, org, role, project) {
    ...
    KLOUD_CONSTANTS.env.prj = _ => asyncContextStorage.getStore().project||KLOUD_CONSTANTS.DEFAULT_PROJECT;
}
