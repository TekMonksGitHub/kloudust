...
module.exports.exec = async function (params) {
    ...
    // Extract gateway IP by modifying last octet
    ...
    const rules = JSON.parse(firewallRules);
    ...
    const xforgeArgs = {
        ...
        other: [
            ...
            `${KLOUD_CONSTANTS.LIBDIR}/cmd/scripts/firewallvm.sh`, action, protocol, direction, sourceIp, destinationIp, port
        ]
    };
