/** 
 * listS3storageForOrgOrProject.js - Lists the s3storage buckets for project or org.
 * 
...
module.exports.exec = async function(params) {
    ...
    const buckets = await dbAbstractor.listS3storageForOrgOrProject(org, project);
